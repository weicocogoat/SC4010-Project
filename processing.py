...
def savitzky_golay(y, window_size, order, deriv = 0, rate = 1):
	'''
	Signal Processing to smoothen out the waveform
...
def get_signatures(file, traces):
	...
	# 	limit = 50
	# 	threshold = Otsu's Thresholding on sequence lengths // Searches for threshold intensity which maximizes the between class variance. In our case, it determines how long (datapoints on trace) would 1 bit be
...
if __name__ == '__main__':
	...
	pp.figure().canvas.manager.set_window_title('RSA on Arduino')
